    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="registration-section">
                <h3 class="registration-title">Event Registration</h3>
                ...
                @if($event->max_participants)
                    <div class="participants-info">
                        ...
                        <div class="participants-bar">
                            @php
                                $percentage = $event->max_participants > 0 ? (($event->registered_count ?? 0) / $event->max_participants) * 100 : 0;
                            @endphp
                ...
                @if($status === 'upcoming' && $event->is_active)
                    ...
                    @elseif($event->max_participants && ($event->registered_count ?? 0) >= $event->max_participants)
                        <div class="registration-info">
